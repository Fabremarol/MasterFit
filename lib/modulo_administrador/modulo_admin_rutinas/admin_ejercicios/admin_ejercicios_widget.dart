...
import '/modulo_administrador/modulo_admin_rutinas/bs_editar_ejercicios/bs_editar_ejercicios_widget.dart';
import '/modulo_administrador/modulo_admin_rutinas/bs_ejercicio_component/bs_ejercicio_component_widget.dart';
...
import 'admin_ejercicios_model.dart';
export 'admin_ejercicios_model.dart';

class AdminEjerciciosWidget extends StatefulWidget {
  const AdminEjerciciosWidget({
    Key? key,
    required this.subRutinas2,
  }) : super(key: key);

  final RutinasRecord? subRutinas2;

  @override
  _AdminEjerciciosWidgetState createState() => _AdminEjerciciosWidgetState();
}

class _AdminEjerciciosWidgetState extends State<AdminEjerciciosWidget> {
  late AdminEjerciciosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminEjerciciosModel());
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            context.pushNamed(
              'CrearEjercicio',
              queryParameters: {
                'subRutina': serializeParam(
                  widget.subRutinas2,
                  ParamType.Document,
                ),
              }.withoutNulls,
              extra: <String, dynamic>{
                'subRutina': widget.subRutinas2,
              },
            );
          },

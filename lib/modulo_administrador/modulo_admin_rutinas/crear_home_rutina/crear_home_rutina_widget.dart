...
import 'crear_home_rutina_model.dart';
export 'crear_home_rutina_model.dart';

class CrearHomeRutinaWidget extends StatefulWidget {
  const CrearHomeRutinaWidget({Key? key}) : super(key: key);

  @override
  _CrearHomeRutinaWidgetState createState() => _CrearHomeRutinaWidgetState();
}

class _CrearHomeRutinaWidgetState extends State<CrearHomeRutinaWidget> {
  late CrearHomeRutinaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearHomeRutinaModel());
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await RutinasRecord.collection
                                          .doc()
                                          .set(createRutinasRecordData(
                                            nombreRutina: _model
                                                .txtfldNombreController.text,
                                            descripcion: _model

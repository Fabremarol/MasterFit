...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xADED1717);
  late Color secondary = const Color(0xFF8E8D8D);
  late Color tertiary = const Color(0xFF373434);
  ...
  late Color accent1 = const Color(0xFF1EC9E9);
  late Color accent2 = const Color(0xFF3FA5B5);
  late Color accent3 = const Color(0xFFC3844A);
  late Color accent4 = const Color(0xFFFF613B);
  ...
  late Color jet = Color(0xFF373434);
  late Color fireBrick = Color(0xFFAD2523);
  late Color battleshipGray = Color(0xFF8E8D8D);
  late Color raisinBlack = Color(0xFF231F20);
  late Color white = Color(0xFFFFFFFF);
  late Color fondoRutinas = Color(0x45AD2523);

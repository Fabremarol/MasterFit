...
class CalendarioActividadesWidget extends StatefulWidget {
  const CalendarioActividadesWidget({Key? key}) : super(key: key);

  @override
  _CalendarioActividadesWidgetState createState() =>
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<ActividadesRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<ActividadesRecord> listViewActividadesRecordList =
                            snapshot.data!;
                        return ListView.builder(
                          ...
                          itemCount: listViewActividadesRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewActividadesRecord =
                                listViewActividadesRecordList[listViewIndex];
                            return Padding(
